...
{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-cancel"],va:"Annuler"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Confirmer"}]}]}]});this.i=new g.ZK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.H(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},E9=function(a){g.W.call(this,{G:"div",
...
b=g.T(b,128)?g.AH("Erreur sur $RECEIVER_NAME",c):b.Ec()||g.T(b,4)?g.AH("Lecture sur $RECEIVER_NAME",c):g.AH("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Pa("statustext",b);a.i.show()}else a.i.hide()},F9=function(a,b){g.wP.call(this,"Lire sur",0,a,b);
...
F9.prototype.pj=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.Ho[a].name};
