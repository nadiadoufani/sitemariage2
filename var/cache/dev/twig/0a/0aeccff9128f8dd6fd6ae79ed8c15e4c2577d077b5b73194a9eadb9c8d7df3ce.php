...
class __TwigTemplate_57434d915441b9412c17e1afac73e49fde24281207583210256e2264266852fd extends Template
{
    private $source;
    private $macros = [];
...
<h2 class=\"text-capitalize\" >Commentaires <span >";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_USER")) {
            ...
            // line 70
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["photographe"]) || array_key_exists("photographe", $context) ? $context["photographe"] : (function () { throw new RuntimeError('Variable "photographe" does not exist.', 70, $this->source); })()), "id", [], "any", false, false, false, 70), "html", null, true);
            echo "\">
                    </div>
                </form>
                <hr>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["photographe"]) || array_key_exists("photographe", $context) ? $context["photographe"] : (function () { throw new RuntimeError('Variable "photographe" does not exist.', 78, $this->source); })()), "getCommentaire", [], "any", false, false, false, 78));
...
<h2 class=\"text-capitalize\" >Commentaires <span >{{photographe.getCommentaire.count}}</span></h2>
