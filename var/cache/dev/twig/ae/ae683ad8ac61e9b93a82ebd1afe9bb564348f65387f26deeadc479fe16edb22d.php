...
class __TwigTemplate_a77582a845804a243fa9ab2978fe373b6f848d9605933240268bccd9f948a356 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div id=\"about\">
    ...
    <div id=\"card-parent\">
      ...
      <div data-aos=\"flip-left\" data-aos-easing=\"ease-out-cubic\" data-aos-duration=\"1000\" class=\"card-r\" id=\"\">
        ...
        echo "\"<button type=\"submit\" class=\"btn btn-success \" style=\"border-radius: 30%;\"> rendez-vous </button></a>
          <a href=\"";
        // line 44
    ...
    <div id=\"card-parent\">
      ...
      <div data-aos=\"flip-left\" data-aos-easing=\"ease-out-cubic\" data-aos-duration=\"1000\" class=\"card-r\" id=\"\">
        <h2 style=\"font-family: 'Yeon Sung', cursive;\">{{ centredebeaute.nom}}</h2>
          <p> {{ centredebeaute.description}}</p>
          <a href=\"{{ path('rendez_vous')}}\"<button type=\"submit\" class=\"btn btn-success \" style=\"border-radius: 30%;\"> rendez-vous </button></a>
